...
import 'package:tutorial/app/widgets/icons.dart';
                  ...
                  Wrap(
                    ...
                    children: icons.map((e)=> Obx(
                        (){
                          ...
                          return ChoiceChip(selectedColor: Colors.grey[200],pressElevation: 0, backgroundColor:Colors.white,label: e, selected: homeCtrl.chipIndex.value == index,
